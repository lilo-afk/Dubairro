<?php
        ...
        if(!empty($lname) && !empty($email) && !empty($password) && !empty($repete_senha) && isset($_FILES["image"]) && !empty($_FILES["image"]["name"]) && !empty($captcha)){
        //CURL
        $curl = curl_init();
        //REQUISIÇÃO CURL   
        ...
        CURLOPT_POSTFIELDS => [
            'secret' => '6Len30MjAAAAAL2vMFGpxGlMz541qPKR6EdwWunE',
